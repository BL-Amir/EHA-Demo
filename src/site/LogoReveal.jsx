...
function buildLogoRevealTimeline(paths, animatedLayer, onComplete, revealMode = revealModes.sequential, initialComplete = false) {
  ...
  if (initialComplete || prefersReducedMotion) {
    gsap.set(paths, {
...
const LogoReveal = forwardRef(function LogoReveal({
  ...
  const replay = () => {
    ...
    timelineRef.current = buildLogoRevealTimeline(paths, animatedLayer, onComplete, revealMode, initialComplete)
  }
